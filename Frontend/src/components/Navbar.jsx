        ...
        <>
            <div className="h-16 lg:h-16 w-full flex justify-between items-center px-5 md:px-[5%] bg-white z-50 fixed top-0 transition-all duration-300 shadow-md">
                ...
                <div className="hidden lg:flex navOption items-center font-semibold gap-10">
                    ...
                    <Link to="/pricing" className="hover:text-[#326789] transition-colors duration-200 cursor-pointer">Pricing</Link>
                    <DropdownMenu title="Resources" subheading={[{ name: "Events", route: "/events" }, { name: "Tools", route: "/tools" }]} />
                    <Link to="/about" className="hover:text-[#326789] transition-colors duration-200 cursor-pointer">About</Link>
                    <Link to="/contact" className="hover:text-[#326789] transition-colors duration-200 cursor-pointer">Contact Us</Link>
                </div>
                <div className="hidden lg:flex navRight gap-5 items-center">
                    <DropdownMenu title="Login" subheading={[{ name: "Candidate", route: "/signup" }, { name: "Recruiter", route: "/signup" }]} />
                    <Link to="/demo">
                ...
                <div className="lg:hidden flex items-center">
                    <button onClick={toggleMenu} className="p-2 focus:outline-none" aria-label="Toggle menu">
                        {isOpen ? <X size={40} className="text-[#326789] transition-transform duration-300" /> : <Menu size={40} className="transition-transform duration-300" />}
                    </button>
                </div>
            </div>
