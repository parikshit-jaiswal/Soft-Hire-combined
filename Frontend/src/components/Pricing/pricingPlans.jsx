...
import { PricingDetails as plans } from "@/constants/plans";

const PricingDetails = () => {

  return (
    <div className="flex flex-col items-center p-8">
      <h1 className="text-4xl font-bold">Pricing Plans for Buisness</h1>
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-6">
        {plans.map((plan, index) => (
          ...
          >
            ...
            <p className="text-3xl font-bold mt-4">{plan.price}/year</p>
            ...
            <p className="text-gray-500 text-sm">Everything in the {plan.name}</p>
            <ul className="text-left mt-2 space-y-2">
              {plan.features.map((feature, i) => (
                <li key={i} className="flex items-center text-gray-500 text-sm ">
                  <img src="pricing/tick.svg" alt="tick" className="pt-1" /> <span className="ml-2 pt-1">{feature}</span>
                </li>
              ))}
            </ul>
          </div>
