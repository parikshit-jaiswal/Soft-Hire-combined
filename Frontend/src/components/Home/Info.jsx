...
function Card({ heading, buttonText, icon }) {
    return (
        <div className="border rounded-3xl p-3 py-6 mid:py-10 flex-grow flex flex-col space-y-3">
            <p className="iconGradient rounded-full h-8 w-8 md:h-12 md:w-12 flex items-center justify-center ">
                <p className="bg-[#326789] h-6 w-6 md:h-9 md:w-9 rounded-full flex items-center justify-center">
                    {icon}
                </p>
            </p>
            <p className=" sm:text-xl lg:text-2xl font-bold mb-3 h-[50%]">{heading}</p>
            <Button className="bg-[#326789] hover:bg-[#326789] hover:opacity-90">{buttonText}</Button>
        </div>
    )
}
...
function Info() {
    ...
    return (
        ...
        //                 <p className="bg-[#326789] h-6 w-6 md:h-[2.2rem] md:w-[2.2rem] rounded-full flex items-center justify-center">
        ...
        //             <Button className="bg-[#326789] hover:bg-[#326789] hover:opacity-90">Know more</Button>
        //         </div>
        //         <div className="border rounded-3xl p-3 py-6 mid:py-10 flex-grow flex flex-col lg:min-h-[300px]">
        //             <p className="iconGradient rounded-full h-8 w-8 md:h-12 md:w-12 flex items-center justify-center mb-8">
        //                 <p className="bg-[#326789] h-6 w-6 md:h-[2.2rem] md:w-[2.2rem] rounded-full flex items-center justify-center">
