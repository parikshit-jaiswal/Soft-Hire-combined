    ...
    const Section = ({ title, children, id }) => {
        return (
            <div className="mb-8">
                ...
                >
                    <h2 className="text-xl font-bold text-[#326789]">{title}</h2>
                    <span className="text-[#326789]">
                        {expanded[id] ? (
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8 bg-white">
            <div className="text-center mb-12">
                <h1 className="text-3xl font-bold text-[#326789] mb-4">Privacy Policy</h1>
            ...
            <Section title="Your rights" id="rights">
                ...
                <p className="py-2">We hope that we can resolve any query or concern you raise about our use of your personal data. You have the right to make a complaint at any time to the supervisory authority in the United Kingdom for data protection issues, the Information Commissioner's Office (ICO), whose website is at <a href="http://www.ico.org.uk/" className="text-[#326789] hover:underline">http://www.ico.org.uk/</a>. We would, however, appreciate the opportunity to deal directly with your concerns beforehand and respond to any these as your first-priority contact. Should you wish to exercise any of these rights, please contact us at <a href="mailto:Divyank@SoftHire.co.uk" className="text-[#326789] hover:underline">Divyank@SoftHire.co.uk</a>.</p>
            </Section>
            ...
            <div className="mt-12 border-t pt-8 text-center text-gray-500">
                ...
                <p className="mt-2">
                    <a href="mailto:Divyank@SoftHire.co.uk" className="text-[#326789] hover:underline">Contact Us</a>
                </p>
            </div>
        </div>
    );
